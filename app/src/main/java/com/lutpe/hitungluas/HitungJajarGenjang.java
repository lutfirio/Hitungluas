...
public class HitungJajarGenjang extends Activity {
     ...
     * Method untuk Menghitung Luas Jajargenjang dipanggil pada saat button
     * Hitung Luas diklik
     *
     * @param view
     */
    ...
    public void backtoMenu(View view){
        Intent intent = new Intent(HitungJajarGenjang.this,MainActivity.class);
        HitungJajarGenjang.this.startActivity(intent);
        HitungJajarGenjang.this.finish();
    }
}